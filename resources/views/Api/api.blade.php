...
FORMAT: <span class="hljs-number">1</span>A</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="user-social" class="resource-group"><h2 class="group-heading">User SOCIAL <a href="#user-social" class="permalink">&para;</a></h2><div id="user-social-list-user-block" class="resource"><h3 class="resource-heading">LIST USER BLOCK <a href="#user-social-list-user-block" class="permalink">&nbsp;&para;</a></h3><div id="user-social-list-user-block-post" class="action post"><h4 class="action-heading"><div class="name">List user block</div><a href="#user-social-list-user-block-post" class="method post">POST</a><code class="uri">/auth/api/user/list-user-block</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/user/list-user-block</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[
  {
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="user-social-remove-user-block" class="resource"><h3 class="resource-heading">REMOVE USER BLOCK <a href="#user-social-remove-user-block" class="permalink">&nbsp;&para;</a></h3><div id="user-social-remove-user-block-post" class="action post"><h4 class="action-heading"><div class="name">Remove user block</div><a href="#user-social-remove-user-block-post" class="method post">POST</a><code class="uri">/auth/api/user/remove-user-block</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/user/remove-user-block</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="user-social-change-information" class="resource"><h3 class="resource-heading">CHANGE INFORMATION <a href="#user-social-change-information" class="permalink">&nbsp;&para;</a></h3><div id="user-social-change-information-post" class="action post"><h4 class="action-heading"><div class="name">change information</div><a href="#user-social-change-information-post" class="method post">POST</a><code class="uri">/auth/api/user/change-information</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/user/change-information</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"Change information success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="user-social-search-user" class="resource"><h3 class="resource-heading">SEARCH USER <a href="#user-social-search-user" class="permalink">&nbsp;&para;</a></h3><div id="user-social-search-user-get" class="action get"><h4 class="action-heading"><div class="name">change information</div><a href="#user-social-search-user-get" class="method get">GET</a><code class="uri">/auth/api/user/search-user</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/user/search-user</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
FORMAT: <span class="hljs-number">1</span>A</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="post-social" class="resource-group"><h2 class="group-heading">POST SOCIAL <a href="#post-social" class="permalink">&para;</a></h2><div id="post-social-list-post" class="resource"><h3 class="resource-heading">LIST POST <a href="#post-social-list-post" class="permalink">&nbsp;&para;</a></h3><div id="post-social-list-post-post" class="action post"><h4 class="action-heading"><div class="name">List post</div><a href="#post-social-list-post-post" class="method post">POST</a><code class="uri">/auth/api/post/list-post</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/list-post</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[
  {
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
      {
        ...
        "<span class="hljs-attribute">token_reset_password</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
        "<span class="hljs-attribute">token_reset_password_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
        "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-string">"2021-04-19T02:40:25.000000Z"</span></span>,
        "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-string">"2021-04-19T02:40:25.000000Z"</span></span>,
        "<span class="hljs-attribute">users</span>": <span class="hljs-value">[]</span>,
        "<span class="hljs-attribute">post</span>": <span class="hljs-value">[
          {
            "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">4</span></span>,
            "<span class="hljs-attribute">content</span>": <span class="hljs-value"><span class="hljs-string">"fdfsffdfgggg"</span></span>,
            "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
            "<span class="hljs-attribute">created_by</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
            "<span class="hljs-attribute">share_post_id</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
            ...
            "<span class="hljs-attribute">like_count</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
            "<span class="hljs-attribute">count_user_count</span>": <span class="hljs-value"><span class="hljs-number">0</span>
          </span>}
        ]</span>,
        "<span class="hljs-attribute">user_from</span>": <span class="hljs-value">[]</span>,
        "<span class="hljs-attribute">user_to</span>": <span class="hljs-value">[]
      </span>}
    ]
  </span>}
]</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-add-post" class="resource"><h3 class="resource-heading">ADD POST <a href="#post-social-add-post" class="permalink">&nbsp;&para;</a></h3><div id="post-social-add-post-post" class="action post"><h4 class="action-heading"><div class="name">Add post</div><a href="#post-social-add-post-post" class="method post">POST</a><code class="uri">/auth/api/post/add-post</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/add-post</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"add post success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-remove-post" class="resource"><h3 class="resource-heading">REMOVE POST <a href="#post-social-remove-post" class="permalink">&nbsp;&para;</a></h3><div id="post-social-remove-post-post" class="action post"><h4 class="action-heading"><div class="name">Remove post block</div><a href="#post-social-remove-post-post" class="method post">POST</a><code class="uri">/auth/api/post/remove-post</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/remove-post</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"remove post success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-detail-post" class="resource"><h3 class="resource-heading">DETAIL POST <a href="#post-social-detail-post" class="permalink">&nbsp;&para;</a></h3><div id="post-social-detail-post-get" class="action get"><h4 class="action-heading"><div class="name">detail post</div><a href="#post-social-detail-post-get" class="method get">GET</a><code class="uri">/auth/api/post/detail-post/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/detail-post/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">4</span></span>,
    "<span class="hljs-attribute">content</span>": <span class="hljs-value"><span class="hljs-string">"fdfsffdfgggg"</span></span>,
    "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-update-post" class="resource"><h3 class="resource-heading">UPDATE POST <a href="#post-social-update-post" class="permalink">&nbsp;&para;</a></h3><div id="post-social-update-post-post" class="action post"><h4 class="action-heading"><div class="name">update post</div><a href="#post-social-update-post-post" class="method post">POST</a><code class="uri">/auth/api/post/update-post/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/update-post/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"update post success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-remove-post-1" class="resource"><h3 class="resource-heading">REMOVE POST <a href="#post-social-remove-post-1" class="permalink">&nbsp;&para;</a></h3><div id="post-social-remove-post-post-1" class="action post"><h4 class="action-heading"><div class="name">remove post</div><a href="#post-social-remove-post-post-1" class="method post">POST</a><code class="uri">/auth/api/post/remove-post/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/remove-post/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"remove post success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-user-like" class="resource"><h3 class="resource-heading">USER LIKE <a href="#post-social-user-like" class="permalink">&nbsp;&para;</a></h3><div id="post-social-user-like-post" class="action post"><h4 class="action-heading"><div class="name">user like</div><a href="#post-social-user-like-post" class="method post">POST</a><code class="uri">/auth/api/post/user-like/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/user-like/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">4</span></span>,
      "<span class="hljs-attribute">content</span>": <span class="hljs-value"><span class="hljs-string">"test 12345"</span></span>,
      "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
      "<span class="hljs-attribute">created_by</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
      "<span class="hljs-attribute">share_post_id</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
      "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
      "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-string">"2021-04-19T02:46:46.000000Z"</span></span>,
      "<span class="hljs-attribute">like</span>": <span class="hljs-value">[]
    </span>}
  ]
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="post-social-user-share" class="resource"><h3 class="resource-heading">USER SHARE <a href="#post-social-user-share" class="permalink">&nbsp;&para;</a></h3><div id="post-social-user-share-post" class="action post"><h4 class="action-heading"><div class="name">user-share</div><a href="#post-social-user-share-post" class="method post">POST</a><code class="uri">/auth/api/post/user-share/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/post/user-share/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"data"</span>: [
            {
                <span class="hljs-string">"id"</span>: <span class="hljs-number">4</span>,
                <span class="hljs-string">"content"</span>: <span class="hljs-string">"test 12345"</span>,
                <span class="hljs-string">"status"</span>: <span class="hljs-number">1</span>,
                <span class="hljs-string">"created_by"</span>: <span class="hljs-number">57</span>,
                <span class="hljs-string">"share_post_id"</span>: <span class="hljs-literal">null</span>,
                <span class="hljs-string">"created_at"</span>: <span class="hljs-literal">null</span>,
                <span class="hljs-string">"updated_at"</span>: <span class="hljs-string">"2021-04-19T02:46:46.000000Z"</span>,
                <span class="hljs-string">"count_user"</span>: []
            }
        ]
}
FORMAT: <span class="hljs-number">1</span>A</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="friend-social" class="resource-group"><h2 class="group-heading">FRIEND SOCIAL <a href="#friend-social" class="permalink">&para;</a></h2><div id="friend-social-list-friend" class="resource"><h3 class="resource-heading">LIST FRIEND <a href="#friend-social-list-friend" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-list-friend-post" class="action post"><h4 class="action-heading"><div class="name">List friend</div><a href="#friend-social-list-friend-post" class="method post">POST</a><code class="uri">/auth/api/friend/list-friend</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/list-friend</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[
  {
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
      {
        "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
        ...
        "<span class="hljs-attribute">users</span>": <span class="hljs-value">[
          {
            ...
            "<span class="hljs-attribute">from_id</span>": <span class="hljs-value"><span class="hljs-number">18</span></span>,
            "<span class="hljs-attribute">to_id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
            "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
            "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
            "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span>
          </span>}
...
]</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="friend-social-request-friend" class="resource"><h3 class="resource-heading">REQUEST FRIEND <a href="#friend-social-request-friend" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-request-friend-post" class="action post"><h4 class="action-heading"><div class="name">Request friend</div><a href="#friend-social-request-friend-post" class="method post">POST</a><code class="uri">/auth/api/friend/request-friend</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/request-friend</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
      "<span class="hljs-attribute">name</span>": <span class="hljs-value"><span class="hljs-string">"duongtv"</span></span>,
      ...
      "<span class="hljs-attribute">users</span>": <span class="hljs-value">[
        {
          ...
          "<span class="hljs-attribute">from_id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
          "<span class="hljs-attribute">to_id</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
          "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-string">"2021-04-19T03:00:51.000000Z"</span></span>,
          "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-string">"2021-04-19T03:00:51.000000Z"</span>
        </span>},
        {
          "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">20</span></span>,
          "<span class="hljs-attribute">from_id</span>": <span class="hljs-value"><span class="hljs-number">2</span></span>,
          "<span class="hljs-attribute">to_id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
          "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
          "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span>
        </span>},
        {
          ...
          "<span class="hljs-attribute">from_id</span>": <span class="hljs-value"><span class="hljs-number">54</span></span>,
          "<span class="hljs-attribute">to_id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
          "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
          "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span>
        </span>},
        {
          ...
          "<span class="hljs-attribute">from_id</span>": <span class="hljs-value"><span class="hljs-number">3</span></span>,
          "<span class="hljs-attribute">to_id</span>": <span class="hljs-value"><span class="hljs-number">57</span></span>,
          "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span></span>,
          "<span class="hljs-attribute">updated_at</span>": <span class="hljs-value"><span class="hljs-literal">null</span>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="friend-social-send-request-friend" class="resource"><h3 class="resource-heading">SEND REQUEST FRIEND <a href="#friend-social-send-request-friend" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-send-request-friend-post" class="action post"><h4 class="action-heading"><div class="name">send request friend</div><a href="#friend-social-send-request-friend-post" class="method post">POST</a><code class="uri">/auth/api/friend/send-request-friend</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/send-request-friend</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"send request friend success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="friend-social-remove-friend" class="resource"><h3 class="resource-heading">REMOVE FRIEND <a href="#friend-social-remove-friend" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-remove-friend-post" class="action post"><h4 class="action-heading"><div class="name">remove friend</div><a href="#friend-social-remove-friend-post" class="method post">POST</a><code class="uri">/auth/api/friend/remove-friend/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/remove-friend/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"remove request friend success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="friend-social-accept-friend" class="resource"><h3 class="resource-heading">ACCEPT FRIEND <a href="#friend-social-accept-friend" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-accept-friend-post" class="action post"><h4 class="action-heading"><div class="name">accept friend</div><a href="#friend-social-accept-friend-post" class="method post">POST</a><code class="uri">/auth/api/friend/accept-friend/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/accept-friend/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"accept request success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="friend-social-remove-post" class="resource"><h3 class="resource-heading">REMOVE POST <a href="#friend-social-remove-post" class="permalink">&nbsp;&para;</a></h3><div id="friend-social-remove-post-post" class="action post"><h4 class="action-heading"><div class="name">remove post</div><a href="#friend-social-remove-post-post" class="method post">POST</a><code class="uri">/auth/api/friend/remove-post/2</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/auth/api/friend/remove-post/2</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    <span class="hljs-string">"remove post success"</span>
}</code></pre><div style="height: 1px;"></div></div></div></div></div></section></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 18 Apr 2021</p><script>/* eslint-env browser */
